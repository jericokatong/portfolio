...
function typing() {
  blankText = currentWord.slice(0, ++i);
  document.querySelector('.home_data .home_subtitle').textContent = blankText;

  if (blankText.length == currentWord.length) {
    i = 0;
    wordIndex = (wordIndex + 1) % words.length;
    currentWord = words[wordIndex];
    setTimeout(typing, 2000); // Jeda 2 detik sebelum mengetik kata berikutnya
  } else {
...
// Contact Form
const scriptURL =
  'https://script.google.com/macros/s/AKfycbxDA6RW6OA3vwGksJE1mX_PQIPqTn3cT8TwIqsdDg2JIApNhIL2iWVlriwkEUZ970kX/exec';
